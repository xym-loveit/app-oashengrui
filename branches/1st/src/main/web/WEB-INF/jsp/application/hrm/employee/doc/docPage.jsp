	...
	<div class="tabs" currentindex="0" eventtype="click">
		<div class="tabsHeader">
			<div class="tabsHeaderContent">
				<ul>
					<li class="selected"><a href="app/hrm/hire.do?action=hrmPageJobResume&empId=${employee.id}&resumeId=${employee.resume.id}&cat=dev" class="j-ajax"><span>基础信息</span></a></li>
