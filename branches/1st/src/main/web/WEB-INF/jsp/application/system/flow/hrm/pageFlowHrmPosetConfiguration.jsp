...
<div class="pageContent bol" style="margin-left: 260px;">
	...
	<div class="panelBar">
		<ul class="toolBar">
			...
			<li class="line">line</li>
			<li><a class="add" href="app/flow/${typeSlug}.do?action=dialogFlowTaskConfigurationPage&procDefId={_var_fdefid}${fn:length(prcessDefs) gt 1 ? '&istran' : ''}" mask="true" warn="请从左侧选择流程定义" target="dialog" title="添加流程节点" width="215" height="400" rel="dia_flowtask_add_${processType.id}"><span>添加流程节点</span></a></li>
			<li class="line">line</li>
		</ul>
	</div>
