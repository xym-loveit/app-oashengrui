...
CREATE TABLE IF NOT EXISTS `app_admin_doc` (
  ...
  KEY `PK_file` (`file_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='行政管理-文档' AUTO_INCREMENT=3 ;
...
(1, 1, 'DOC1', 1, 1, '', NULL, 1, 15, 1, '2012-08-02 20:25:38', 36),
(2, 2, 'DOC2', 1, 1, NULL, NULL, 1, 15, 36, '2012-08-02 20:57:20', 37);
...
CREATE TABLE IF NOT EXISTS `app_admin_task` (
  ...
  PRIMARY KEY (`task_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='行政管理-任务委托' AUTO_INCREMENT=11 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='任务委托审批记录' AUTO_INCREMENT=11 ;
...
CREATE TABLE IF NOT EXISTS `app_file_attach` (
  ...
  PRIMARY KEY (`file_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='附件' AUTO_INCREMENT=52 ;
...
CREATE TABLE IF NOT EXISTS `app_function_url` (
  ...
  PRIMARY KEY (`url_id`),
  KEY `func_id` (`func_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='功能URL' AUTO_INCREMENT=311 ;
...
(36, '00006002', 24, 1, 'ljx', 22, NULL, '28056121', '', '', '', NULL, NULL, 2, NULL, NULL, NULL, NULL, 55, NULL, '2012-07-31', 1, '2012-07-31 21:37:38', NULL),
...
CREATE TABLE IF NOT EXISTS `app_process_definition` (
  ...
  PRIMARY KEY (`def_id`),
  KEY `type_id` (`type_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='流程定义' AUTO_INCREMENT=21 ;
...
(7, 4, NULL, NULL, NULL, 2, NULL, NULL, NULL, NULL, NULL, NULL, '25', '38', NULL, 2);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='角色表' AUTO_INCREMENT=22 ;
...
(19, '会议发起权限', 'ROLE_TASK_BUILD', '', 1, '_FUNCKEY_PERSONAL_CONFERENCE_INITIAL_CONFERENCE,_FUNCKEY_PERSONAL_CONFERENCE_SUMMARY_CONFERENCE,_FUNCKEY_PERSONAL_CONFERENCE_VIEW_CONFERENCE,_FUNCKEY_PERSONAL_CONFERENCE_VIEW_MY_INITIAL_CONFERENCE,_FUNCKEY_ADMIN_NEWS_ADD,_FUNCKEY_ADMIN_DOC_ADD,_FUNCKEY_HRM_JOBHIRE_JOB_POST,_FUNCKEY_HRM_EMPLOYEE_ADD,_FUNCKEY_ADMIN_ACCOUNT_PASSWORD_RESET', 0, 1),
(20, '会议管理权限', 'ROLE_TASK_APPROVE', '', 1, '_FUNCKEY_PERSONAL_CONFERENCE_SUMMARY_CONFERENCE,_FUNCKEY_PERSONAL_CONFERENCE_ACTIVATE_CONFERENCE,_FUNCKEY_PERSONAL_CONFERENCE_ADJUST_CONFERENCE,_FUNCKEY_ADMIN_TASK_APPROVE,_FUNCKEY_ADMIN_TASK_VIEW,_FUNCKEY_ADMIN_TASK_EDIT', 0, 1),
(21, '会议参与权限', 'ROLE_TASK_JOIN', '', 1, '_FUNCKEY_PERSONAL_TASK_ACCOMPLISH,_FUNCKEY_PERSONAL_TASK_APPROVES_VIEW,_FUNCKEY_PERSONAL_TASK_POSTPONE,_FUNCKEY_PERSONAL_TASK_VIEW,_FUNCKEY_PERSONAL_CONFERENCE_VIEW_CONFERENCE', 0, 1);
...
CREATE TABLE IF NOT EXISTS `app_school_department_position` (
  ...
  PRIMARY KEY (`pos_id`),
  KEY `dep_id` (`dep_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='部门岗位' AUTO_INCREMENT=39 ;
...
(21, '教务专员', '', 1, 23, 'ROLE_TASK_APPROVE'),
(22, '行政总监', '', 0, 24, 'ROLE_TASK_BUILD'),
(23, '行政专员', '', 1, 24, 'ROLE_EMPLOYEE_HEADOFFICE,ROLE_TASK_JOIN'),
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='职位岗位' AUTO_INCREMENT=10 ;
...
CREATE TABLE IF NOT EXISTS `app_system_log` (
  ...
  PRIMARY KEY (`log_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='系统日志' AUTO_INCREMENT=182 ;
...
(1, 'admin', 'jGl25bVBBBW96Qi9Te4V37Fnqchz/Eu4qB9vKrRIqRg=', '管理员', 'csx@jee-soft.cn', NULL, 26, 1, 19, NULL, NULL, NULL, NULL, NULL, NULL, 1, '0:0:0:0:0:0:0:1', '2012-08-06 22:47:31'),
(19, '00001001', 'ro+N+ETeTFw+SYrc4TnIzXuXWwO93mUJgr0ArrsNPfk=', '罗佳驹', NULL, 15, 26, 1, 19, NULL, NULL, NULL, NULL, NULL, NULL, 1, '125.118.54.30', '2012-08-03 16:28:07'),
(20, '00001002', 'YtwP6mUL0cqp45wC4yCgaYVYKkKWE4LUtMn1mqljowc=', '梅杰', NULL, 15, 13, 1, 20, NULL, NULL, NULL, NULL, NULL, NULL, 1, '0:0:0:0:0:0:0:1', '2012-08-06 22:23:13'),
...
(27, '00006001', 'AdR3o6rcgoyXwyqu2QCIn/IbWgsYIfDIbybGB7ESK+k=', '杨琪', NULL, 24, 23, 1, 27, NULL, NULL, NULL, NULL, NULL, NULL, 1, '0:0:0:0:0:0:0:1', '2012-08-05 19:36:54'),
...
(30, '00005003', 'yFKhbyaKjjizMHXNo0w0Kp45bl/g3/5fRBNJKMmq8t0=', '苏斯翔', NULL, 23, 21, 1, 30, NULL, NULL, NULL, NULL, NULL, NULL, 1, '0:0:0:0:0:0:0:1', '2012-08-01 11:22:01'),
...
(36, '00006002', 'gfbTaJlUYHQ1K6VFo1nJ+W4jxm7NEPtO9Kl3H4xm070=', 'ljx', NULL, 24, 22, 1, 36, NULL, NULL, NULL, NULL, NULL, NULL, 1, '0:0:0:0:0:0:0:1', '2012-08-03 12:10:03'),
(37, '00003004', '8JxP5z5ukGlNHehkcTvpwUFoej2ycC+LHDt785I/Cos=', '林立', NULL, 17, 16, 1, 37, NULL, NULL, NULL, NULL, NULL, NULL, 1, '125.118.54.30', '2012-08-03 16:38:24');
