...
) ENGINE=InnoDB AUTO_INCREMENT=68 DEFAULT CHARSET=utf8 COMMENT='行政管理-文档';
...
INSERT INTO `app_admin_doc` VALUES (67,1,'阿萨德',1,1,'',NULL,1,7,1,'2012-07-18 17:00:04');
...
#
# Source for table app_dictionary
#
...
LOCK TABLES `app_dictionary` WRITE;
/*!40000 ALTER TABLE `app_dictionary` DISABLE KEYS */;
/*!40000 ALTER TABLE `app_dictionary` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `app_user` VALUES (1,'admin','jGl25bVBBBW96Qi9Te4V37Fnqchz/Eu4qB9vKrRIqRg=','???','csx@jee-soft.cn',NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,'127.0.0.1','2012-07-16 16:39:30');
