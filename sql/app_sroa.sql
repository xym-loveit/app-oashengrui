...
CREATE TABLE `app_process_type` (
  ...
  PRIMARY KEY  (`type_id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='流程分类';
...
CREATE TABLE `app_system_log` (
  ...
  PRIMARY KEY  (`log_id`)
) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=utf8 COMMENT='系统日志';
...
INSERT INTO `app_user` VALUES ('1', 'admin', 'jGl25bVBBBW96Qi9Te4V37Fnqchz/Eu4qB9vKrRIqRg=', '卡卡西', 'csx@jee-soft.cn', null, null, '1', null, null, null, null, null, null, null, '1', '127.0.0.1', '2012-06-28 20:58:39');
