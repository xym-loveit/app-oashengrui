...
<div class="pageContent bor" style="float:left; width: 240px;">
	...
	<div class="panelBar">
		<ul class="toolBar">
			<c:if test="${tm:ifGranted('_FUNCKEY_SYSTEM_MENU_REFRESH')}">
			...
			<c:if test="${tm:ifGranted('_FUNCKEY_SYSTEM_MENU_ADD')}">
			...
			<c:if test="${tm:ifGranted('_FUNCKEY_SYSTEM_MENU_EDIT')}">
...
<div class="pageContent bol" style="margin-left: 250px;">
	...
	<div class="panelBar">
		<ul class="toolBar">
			<c:if test="${tm:ifGranted('_FUNCKEY_SYSTEM_MENU_FUNC_REFRESH')}">
			...
			<c:if test="${tm:ifGranted('_FUNCKEY_SYSTEM_MENU_FUNC_EDIT')}">
