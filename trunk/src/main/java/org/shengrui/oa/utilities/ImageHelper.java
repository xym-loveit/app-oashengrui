...
public class ImageHelper {   
   ...
   private static BufferedImage resize(BufferedImage source, int targetW,   
       ...
       // 这里想实现在 targetW，targetH范围内实现等比缩放。如果不需要等比缩放   
       // 则将下面的 if else语句注释即可   
       if (sx < sy) {   
           sx = sy;   
   ...
   public static void saveImageAsJpg(String inFilePath, String outFilePath,   
	    ...
	    String toDir = outFilePath.substring(0,outFilePath.lastIndexOf(System.getProperty("file.separator")));
  ...
  public static void main(String[] args){
	  try {
		ImageHelper.saveImageAsJpg("D:\\x36zhao\\Personal\\Photos\\Headers\\100322103174eb36eba2d29dd9.jpg", "d:\\x36zhao\\desktop\\test.jpg", 600, 400, true);
	} catch (Exception e) {
