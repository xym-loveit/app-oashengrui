				...
				<tr target="mid" rel="${entity.id}">
					...
					<td>
						<c:choose>
							...
							<c:otherwise>
								<a class="oplink" href="app/hrm/hire/interview.do?action=hrmPageJobOfferInterviewIndex&issueId=${entity.jobHireIssue.id}" target="dialog" title="面试记录‘${entity.jobHireIssue.resume.fullName}’" mask="true" rel="myinterview_interviewdetail_${entity.id}">面试记录</a>
							</c:otherwise>
						</c:choose>
					</td>
				</tr>
