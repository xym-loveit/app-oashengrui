...
<div class="pageContent">
	<form method="post" action="app/hrm/hire/interview.do?action=actionJobInterviewPlanSave" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
