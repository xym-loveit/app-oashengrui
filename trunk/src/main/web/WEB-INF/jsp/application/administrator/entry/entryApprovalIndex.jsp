			...
			<logic:present name="newsInfo">	
				<logic:iterate name="newsInfo" property="items" id="newsInfo">
						<tr target="sid" rel="${newsInfo.id }" id="newsInfo-${newsInfo.id}">
							...
							<td style="text-align:left; padding-left: 5px;"><a class="" href="app/admin/news.do?action=actionNewsScan&id=${newsInfo.id }&op=view" target="dialog" rel="admin_entrycheck" width="900" height="500">${newsInfo.newsSubject}</a></td>
							<td>
								<c:choose>
