...
<div class="pageContent bor" style="float:left; width: 240px;">
	...
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="refresh" href="app/system/menu.do?action=actionLoadMenuItemTree" target="ajax" rel="ajBoxMenuTree" title="刷新" rel="dia_admin_entryadd" callback="func_refresh();"><span>刷新</span></a></li>
...
<div class="pageContent bol" style="margin-left: 250px;">
	...
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="refresh uvar" href="app/system/menu.do?action=actionLoadMenuFuncList&menuId={_var_menuid}" warn="请选择菜单项!" target="ajax" rel="ajBoxMenuFunc" title="刷新" rel="dia_admin_entryadd"><span>刷新</span></a></li>
			<li class="line">line</li>
			<li><a class="add" href="app/system/menu.do?action=dialogMenuFuncPage&menuId={_var_menuid}" mask="true" warn="请选择菜单项!" target="dialog" title="添加菜单功能" width="504" height="389" rel="dia_admin_entryadd"><span>添加功能</span></a></li>
			<li class="line">line</li>
