		...
		<logic:present name="menuFuncs">
			<logic:iterate name="menuFuncs" id="entity">
				<tr target="funcid" rel="${entity.id}" id="mfunc-${entity.id}">
					...
					<td>
						<a href="app/system/menu/func.do?action=dialogMenuFuncPage&funcId=${entity.id}" class="oplink" target="dialog" title="菜单功能编辑" width="504" height="500" rel="sys_menufuncedit-${entity.id}">编辑</a>
					</td>
					<td>
