...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='员工档案表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='员工历程';

-- ----------------------------
-- Table structure for app_hrm_entries
-- ----------------------------
DROP TABLE IF EXISTS `app_hrm_entries`;
CREATE TABLE `app_hrm_entries` (
  `entry_id` bigint(20) NOT NULL auto_increment,
  `resume_id` bigint(20) NOT NULL COMMENT '简历ID',
  `dep_id` bigint(20) NOT NULL COMMENT '入职部门ID',
  `district_id` bigint(20) NOT NULL COMMENT '入职校区ID',
  PRIMARY KEY  (`entry_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='员工入职安排表';
...
CREATE TABLE `app_hrm_hire_interviews` (
  ...
  PRIMARY KEY  (`hw_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='招聘面试';
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='当前招聘';
...
CREATE TABLE `app_hrm_hire_job` (
  ...
  PRIMARY KEY  (`hjob_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='招聘岗位发布';
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='简历管理';
...
CREATE TABLE `app_school_department` (
  ...
  PRIMARY KEY  (`dep_id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='学校部门设置';
...
CREATE TABLE `app_school_department_position` (
  ...
  PRIMARY KEY  (`pos_id`),
  KEY `dep_id` (`dep_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='部门岗位';
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='app_user\r\n用户表';
...
INSERT INTO `app_hrm_employee` VALUES ('1', 'qweq', '1', '1', 'qwewqe', '1', '2012-06-21', 'eqe2w3', '23424', '2012-06-29', '2012-06-29', '0', null, 'Y', '1', '2012-06-29 20:50:44');
INSERT INTO `app_hrm_hire_interviews` VALUES ('5', '6', '杭州总部', '2012-06-13 14:34:56', '1', '', '1', '0', null);
INSERT INTO `app_hrm_hire_issue` VALUES ('6', '6', '2', '3', null, '2012-06-10 14:34:39');
...
INSERT INTO `app_hrm_resume` VALUES ('6', '佐助', null, null, '火影村', '1', null, '1', null, '13588064354', '火影@163.com', null, null, '1', null, null, '非人类', '', '1', '', '1', '1', null, '362412312412', null, null, null, null, null, null, null, null, '1', '1', '0');
...
INSERT INTO `app_school_department` VALUES ('1', '0', '人资部', '', '0', null, '1');
INSERT INTO `app_school_department` VALUES ('7', '0', '人资部32', '', '0', null, '0');
INSERT INTO `app_school_department` VALUES ('9', '0', '人资部', '', '0', null, '1');
INSERT INTO `app_school_department_position` VALUES ('1', 'qwe', '123', '1', '1', null);
...
INSERT INTO `app_user` VALUES ('1', 'admin', 'jGl25bVBBBW96Qi9Te4V37Fnqchz/Eu4qB9vKrRIqRg=', '卡卡西', 'csx@jee-soft.cn', '1', null, '1', null, null, null, null, null, null, '1', '127.0.0.1', '2012-06-11 21:09:10');
INSERT INTO `app_user` VALUES ('2', 'csx', '9uCh4qxBlFqap/+KiqoM68EqO8yYGpKa1c+BCgkOEa4=', '斩不刀', '111@hotmail.com', '1', null, '3', '', '', '', '', '', '', '0', '', null);
